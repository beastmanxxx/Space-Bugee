...
// Data
const CATEGORIES = [
    { id: 1, name: 'Tees', count: '124 Items', img: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&q=80&w=300' },
    { id: 2, name: 'Shirts', count: '86 Items', img: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&q=80&w=300' },
    { id: 3, name: 'Denim', count: '92 Items', img: 'https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&q=80&w=300' },
    { id: 4, name: 'Outerwear', count: '54 Items', img: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&q=80&w=300' },
    { id: 5, name: 'Accessories', count: '210 Items', img: 'https://images.unsplash.com/photo-1523206489230-c012c7449a2e?auto=format&fit=crop&q=80&w=300' }
];
...
const Navbar = () => `
    ...
    <nav class="navbar">
        ...
        <div class="nav-links desktop-only">
            ...
            <span onclick="navigate('shop')">Pages <i class="ph ph-caret-down"></i></span>
        </div>
        <div class="nav-icons">
            <i class="ph ph-magnifying-glass" onclick="navigate('search')"></i>
            <i class="ph ph-user" onclick="navigate('profile')"></i>
            <i class="ph ph-heart" onclick="navigate('favourites')"></i>
            <div class="cart-icon" onclick="navigate('cart')">
                <i class="ph ph-shopping-cart"></i>
                ${state.cart.length > 0 ? `<span class="cart-badge">${state.cart.length}</span>` : ''}
            </div>
            ${state.user && state.user.email === 'moghaeashu@gmail.com' ? `<i class="ph ph-gear" onclick="window.open('admin.html', '_blank')"></i>` : ''}
        </div>
        ...
        <div class="mobile-menu ${state.isMobileMenuOpen ? 'open' : ''}">
            ...
            <span onclick="navigate('shop'); toggleMobileMenu()">Men</span>
            <span onclick="navigate('shop'); toggleMobileMenu()">Women</span>
            <span onclick="navigate('shop'); toggleMobileMenu()">Kids</span>
...
const HomePage = () => {
    ...
    <section class="section">
        ...
        <div class="category-grid">
            ${CATEGORIES.map(cat => `
                <div class="category-item" onclick="navigate('shop')">
                    <div class="img-wrapper"><img src="${cat.img}" alt="${cat.name}" /></div>
                    <h3>${cat.name}</h3>
                    <span>${cat.count} <i class="ph ph-arrow-right"></i></span>
                </div>
            `).join('')}
        </div>
    </section>
...
const SalePage = () => HomePage(); // Placeholder
const SearchPage = () => ShopPage(); // Placeholder
